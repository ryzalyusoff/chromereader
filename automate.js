  ...
  function showNotification() {
    ...
    chrome.storage.local.get(['hideIframeForever'], function(result) {
      if (result.hideIframeForever === undefined) {
        ...
        //inject the iframe popup notification
        const iframe = document.createElement("iframe");
        iframe.src = chrome.runtime.getURL("popup_notification.html");
        iframe.id = "popupNotification";
        iframe.setAttribute(
          "style",
          "border: none !important; top: 5px !important; right: 5px !important; position: fixed !important; z-index: 2147483647 !important; width: 420px !important; height: 470px !important; margin: 0px !important; padding: 0px !important; border-radius: 15px !important;  border: 1px solid #424242 !important;",
        );
